...
import { getPrivacies, deletePrivacyById } from 'apiSdk/privacies';
...
function PrivacyListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('privacy', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/privacies/view/${id}`);
    }
  };
    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('privacy', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/privacies/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('privacy', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/privacies/edit/${record.id}`} passHref legacyBehavior>
                          <Button
